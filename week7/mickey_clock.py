...
bg = pygame.image.load('C:/Users/Саламат/Desktop/PP2/week7/main-clock.png').convert()
bg_rect = bg.get_rect()
image_left = pygame.image.load("C:/Users/Саламат/Desktop/PP2/week7/left-hand.png")
left_rect = image_left.get_rect(bottomleft = (415,560))
image_right = pygame.image.load("C:/Users/Саламат/Desktop/PP2/week7/right-hand.png")
